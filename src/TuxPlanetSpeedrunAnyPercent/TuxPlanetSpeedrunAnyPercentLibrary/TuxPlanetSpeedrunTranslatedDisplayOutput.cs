...
namespace TuxPlanetSpeedrunAnyPercentLibrary
{
	...
	public class TuxPlanetSpeedrunTranslatedDisplayOutput : IDisplayOutput<GameImage, GameFont>
	{
		private IDisplayOutput<GameImage, GameFont> display;
		private int xOffsetInPixels;
		private int yOffsetInPixels;

		public TuxPlanetSpeedrunTranslatedDisplayOutput(
			IDisplayOutput<GameImage, GameFont> display,
			int xOffsetInPixels,
			int yOffsetInPixels)
		{
			if (display is TuxPlanetSpeedrunTranslatedDisplayOutput)
			{
				TuxPlanetSpeedrunTranslatedDisplayOutput underlyingDisplay = (TuxPlanetSpeedrunTranslatedDisplayOutput)display;
				this.display = underlyingDisplay.display;
				this.xOffsetInPixels = xOffsetInPixels + underlyingDisplay.xOffsetInPixels;
				this.yOffsetInPixels = yOffsetInPixels + underlyingDisplay.yOffsetInPixels;
			}
			else
			{
		...
		public void DrawImageRotatedClockwise(GameImage image, int x, int y, int degreesScaled)
		{
